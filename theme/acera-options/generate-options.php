...
define('MENU_TITLE', 'Website Options'); //Define your menu title
define('MENU_SLUG', 'website_options'); //Define your menu slug, if you don't know what it is, just leave it as it is
...
if (!class_exists('acera_theme_options')) {
    ...
    class acera_theme_options {
        ...
        public function acera_add_menu() {
            add_menu_page(__(MENU_TITLE), __(MENU_TITLE), 'administrator', 'acera_options' . MENU_SLUG, array(&$this, 'acera_display_page'), get_stylesheet_directory_uri()."/acera-options/" . 'images/icon.png');
        }
